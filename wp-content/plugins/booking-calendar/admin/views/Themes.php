		...
		<div id="wpdevart_themes" class="wpdevart-item-container wpdevart-main-item-container">
			...
			<form action="?page=wpdevart-themes" method="post" class="div-for-clear">
				<div id="wpdevart_wpdevart-item_title">
					...
					<input type="button" value="Save" class="action-link wpda-input" name="save" onclick="content_required('save',this)">
					<input type="button" value="Apply" class="action-link wpda-input" name="apply" onclick="content_required('apply',this)">
				</div>
